...
CREATE TABLE databank.dbo.regions (
  region_id INTEGER,
  region_name VARCHAR(9)
);

INSERT INTO databank.dbo.regions
...
CREATE TABLE databank.dbo.customer_nodes (
  customer_id INTEGER,
  region_id INTEGER,
  node_id INTEGER,
  start_date DATE,
...
INSERT INTO databank.dbo.customer_nodes
...
CREATE TABLE databank.dbo.customer_transactions (
  customer_id INTEGER,
  txn_date DATE,
  txn_type VARCHAR(10),
  txn_amount INTEGER
...
INSERT INTO databank.dbo.customer_transactions
